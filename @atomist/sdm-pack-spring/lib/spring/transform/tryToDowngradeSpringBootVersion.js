 ...
 */
exports.TryToDowngradeSpringBootVersion = sdm_pack_build_1.makeBuildAware({
    ...
    name: "boot-downgrade",
    description: `Downgrade Spring Boot version`,
    intent: "try to downgrade Spring Boot",
    transformPresentation: ci => new automation_client_1.editModes.PullRequest(`boot-downgrade`, `Downgrade Spring Boot version to ${ci.parameters.desiredBootVersion}`),
});
function guid() {
    return "" + new Date().getTime();
}
//# sourceMappingURL=tryToDowngradeSpringBootVersion.js.map